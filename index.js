...
let phoneNumber = "18492785095"
let owner = JSON.parse(fs.readFileSync('./data/owner.json'))

global.botname = "DIANA-XMD"
global.themeemoji = "•"
...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'DIANA XMD'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL: QUEEN DIANA`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: QUEEN-DIANA`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: 🧝‍♂️𝐃𝐢𝐚𝐍𝐚 𝐃𝐞𝐯🧝‍♂️ `))
